				...
				<form class="form-horizontal" id="singcms-form">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							...
							<input id="file_upload_image" name="thumb" type="hidden" multiple value="<?php echo ($vo["thumb"]); ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="url" id="inputPassword3" value="<?php echo ($vo["url"]); ?>"  placeholder="请url地址">
						</div>
					</div>
					<div class="form-group">
						<label for="inputname" class="col-sm-2 control-label">文章id:</label>
						<div class="col-sm-5">
							<input type="text" name="id" class="form-control" id="inputname" value="<?php echo ($vo["id"]); ?>" >
						</div>
					</div>
					<div class="form-group">
